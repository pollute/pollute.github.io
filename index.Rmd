...
####Data Question
Here we examine the question... How many monitorining stations in each city in Great Britain have an SO2 value that exceeds 5?
...
Table=AirPollution('GB',5);#finds the cities in Great Britain that have pollution >= 10 micrograms/meter cubed

colnames(Table)[colnames(Table)=="city_name"] <- "City"
colnames(Table)[colnames(Table)=="n"] <- "number of monitoring stations over"
