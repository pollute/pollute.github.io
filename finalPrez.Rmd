...
## Pollutant Levels: Testing Location
  ...
  dashboardBody(
    fluidRow(
      column(width = 4,
        ...
        selectInput("comp","Location",c("urban v. suburban", "traffic v. background"))),
      column(width=4),
      column(width = 4,
    ...
    paste("Comparison between location types was done with a quick-and-dirty two-sample t-test, alpha = 0.05. Assumptions were not tested."))
)
)
...
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) +
  ...
  output$text1 <- renderUI({
    ...
    HTML(sprintf('%s values did %s differ significiantly between location types. (p %s)', input$dataset, not, pvalrend))
  })
...
Table=datatable(Subset, 
                ...
                filter = 'top', 
                colnames = c('Country' = 'iso', 'City' = 'city_name', 'Pollutant Type' = 'component_caption', 'statistic value' = 'statistic_value'),
